...
def get_sqrd_diff() -> float:
    DEFAULT_CRITICAL_SQRD_DIFF: float = 0.35
...
if __name__ == '__main__':
    ...
    while True:
        ...
        template_img = cv2.imread(os.path.join(img_dir_path, 'AutoFishing_template.png'))
        ...
        # 处理匹配结果
        print('\r当前最佳匹配程度：%.2f，匹配结果：' % best_sqrd_diff, end='')
